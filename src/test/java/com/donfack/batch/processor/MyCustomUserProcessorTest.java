...
@ContextConfiguration(classes = {MyCustomUserProcessor.class})
@ExtendWith(SpringExtension.class)
class MyCustomUserProcessorTest {
    @Autowired
    private MyCustomUserProcessor myCustomUserProcessor;
    ...
    void testProcess() throws Exception {
        ...
        User1 actualProcessResult = myCustomUserProcessor.process(employee);
